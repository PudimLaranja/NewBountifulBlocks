...
//$blockRegistration:end
    ...
    public static final ResourceKey<CreativeModeTab> CUSTOM_CREATIVE_TAB_KEY = ResourceKey.create(
            BuiltInRegistries.CREATIVE_MODE_TAB.key(), NewBountifulBlocks.id("newbountifulblocks_tab")
    );
    public static final CreativeModeTab CUSTOM_CREATIVE_TAB = FabricCreativeModeTab.builder()
            .icon(() -> new ItemStack(GLAZED_TERRACOTTA.asItem()))
            .title(Component.translatable("creativeTab.newbountifulblocks"))
